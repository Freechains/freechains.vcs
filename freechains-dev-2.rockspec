...
build = {
    ...
    modules = {
        ...
        ["freechains.chain.db"]     = "src/freechains/chain/db.lua",
        ["freechains.chain.destroy"] = "src/freechains/chain/destroy.lua",
        ...
        ["freechains.chain.replay"] = "src/freechains/chain/replay.lua",
