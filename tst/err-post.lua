...
do
    ...
    TEST "A creates chain + post"
    exec {
        cmd = EXE_A .. " chains add '#err-forge' init file " .. GEN_1,
    }
    exec {
        cmd = EXE_A .. " chain '#err-forge' post inline 'legit' --sign " .. KEY1,
    }
    ...
    FAIL {
        ...
        err = "ERROR : chain sync : invalid post : invalid signature",
    }
end
...
do
    ...
    FAIL {
        ...
        err = "ERROR : chain sync : fetch failed",
    }
end
