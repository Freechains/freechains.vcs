...
do
    ...
    local posts = STATE(ROOT_A .. "/chains/#cons-a/").posts
    local n = 0
...
do
    ...
    TEST "A's posts.lua has only the winning post"
    local posts = STATE(ROOT_A .. "/chains/#cons-b/").posts
    local n = 0
    for _ in pairs(posts) do n = n + 1 end
...
do
    ...
    local posts = STATE(ROOT_A .. "/chains/#cons-c/").posts
    local n = 0
    for _ in pairs(posts) do n = n + 1 end
...
do
    ...
    local posts = STATE(ROOT_C .. "/chains/#cons-d/").posts
    assert (
        posts[P_c] == nil,
