...
do
    ...
    do
        ...
        exec {
            cmd = ENV_EXE .. " --now=300 chain '#cli-now' like 1 post " .. h .. " --sign " .. KEY1,
        }
        local ts = exec {
            cmd = "git -C " .. DIR .. " log -1 --format=%at",
        }
...
do
    ...
    do
        ...
        -- newest first, action commits only (they touch actions/)
        local logs = exec {
            cmd = "git -C " .. DIR .. " log --format=%at -- .freechains/actions/",
        }
        local ts = {}
